...
describe("Create Car", () => {
    ...
    test("Should create a car of each brand and model", async () => {
        ...
        // expect(createdCar).toEqual(carByIdResponse.data.data);
    ...
    test("Should create a car", async () => {
        ...
        const requestBody = { carBrandId: brand.id, carModelId: model.id, mileage: faker.number.int({min: 0, max: 300_000}) }
